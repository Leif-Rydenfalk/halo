...
Generated 2026-09-04. **4 open · 7 cannot determine · 2 measured but Apple's value unknown · 7 match**

| parameter | target | current | delta | state |
|---|---|---|---|---|
| Bluetooth antenna resonant frequency | 2.44 GHz | 4.008 GHz | +1.568 GHz  (64.2%) | **OPEN** |
| Bluetooth antenna resonant frequency (meander variant) | 2.44 GHz | 5.806 GHz | +3.366 GHz  (138.0%) | **OPEN** |
| Board outline diameter | 31.87 mm | 30 mm | -1.87 mm  (5.9%) | **OPEN** |
| PCB thickness | 0.3 mm | 1 mm | +0.7 mm  (233.3%) | **OPEN** |
| Sounder output at 25 cm | 60 Phon | — | — | **CANNOT DETERMINE** |
| Overall stack height | 7.98 mm | — | — | **CANNOT DETERMINE** |
| Antenna realized gain | -3.2 dBi | — | — | **CANNOT DETERMINE** |
...
| Antenna radiation efficiency | CANNOT DETERMINE — Apple publishes gain, not efficiency | — | — | **CANNOT DETERMINE** |
