...
Generated 2026-09-05. **1 open · 4 cannot determine · 3 measured but Apple's value unknown · 15 match**

| parameter | target | current | delta | state |
|---|---|---|---|---|
| PCB thickness (deliberate divergence) | 0.30 mm — deliberately NOT matched, see DECISIONS.md D17 | 0.6 mm | — | **OPEN** |
...
| Solver convergence on the antenna case | 1.0 | 1 | asserted by the tool | **MATCH** |
...
| Implied effective permittivity (physics sanity) | 0.64 to 1.56 — the band a correct model can land in for this geometry | 0.891 - | asserted by the tool | **MATCH** |
