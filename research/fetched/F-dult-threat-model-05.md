# draft-ietf-dult-threat-model-05 (full text)

Source: https://www.ietf.org/archive/id/draft-ietf-dult-threat-model-05.txt
Fetched: 2026-09-03 | Status: ACTIVE I-D, DULT WG, dated 2026-08-06, expires 2027-02-07
...
Expires: 7 February 2027       National Network to End Domestic Violence
                                                               S. Prabhu
                                                                   Nokia
                                                           6 August 2026
                           ...
                           DULT Threat Model
                    draft-ietf-dult-threat-model-05
...
Delano, et al.           Expires 7 February 2027                [Page 1]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027                [Page 2]

Internet-Draft              DULT Threat Model                August 2026
     ...
     3.4.  Possible Attacks on the DULT Protocol . . . . . . . . . .  22
       ...
       3.4.3.  Threat: Deploying Multiple Tags (Finding) . . . . . .  25
       3.4.4.  Threat: Remote Advertisement Monitoring (Accessory,
               Network)  . . . . . . . . . . . . . . . . . . . . . .  26
       3.4.5.  Threat: Physically Modifying Tags (Accessory) . . . .  27
       3.4.6.  Threat: Accessory Firmware Modifications
               (Accessory) . . . . . . . . . . . . . . . . . . . . .  27
       3.4.7.  Threat: Attacker Accessory Disablement (Accessory,
               Finding)  . . . . . . . . . . . . . . . . . . . . . .  28
       3.4.8.  Threat: Tracking Using Target's Own Tag (Network) . .  28
       3.4.9.  Threat: Disabling Target Tag Detection (Network)  . .  29
       3.4.10. Threat: Disabling Target Tag (Accessory, Network) . .  29
       3.4.11. Threat: Impersonation Attack (Tag; Accessory, Finding,
               Network)  . . . . . . . . . . . . . . . . . . . . . .  29
       3.4.12. Threat: Impersonation Attack (Device) . . . . . . . .  30
       3.4.13. Threat: Replay Attack (Accessory, Network)  . . . . .  31
       3.4.14. Threat: Heterogeneous Tag Networks (Accessory, Finding,
               Network)  . . . . . . . . . . . . . . . . . . . . . .  32
       3.4.15. Threat: Deploying GPS Tracker (Accessory) . . . . . .  32
   ...
   4.  Design Considerations . . . . . . . . . . . . . . . . . . . .  34
     4.1.  Limitations of existing approaches to detecting and
       ...
       4.1.1.  Limitation: Spotty Implementation . . . . . . . . . .  35
       4.1.2.  Limitation: Lack of customizability . . . . . . . . .  35
       4.1.3.  Limitation: Difficulty finding and disabling tags . .  36
       4.1.4.  Limitation: Nonconformant Tags  . . . . . . . . . . .  36
       4.1.5.  Limitation: Activities Logs . . . . . . . . . . . . .  37
       4.1.6.  Limitation: Anti-theft mode . . . . . . . . . . . . .  37
     4.2.  Design Requirements . . . . . . . . . . . . . . . . . . .  37
...
Delano, et al.           Expires 7 February 2027                [Page 3]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027                [Page 4]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027                [Page 5]

Internet-Draft              DULT Threat Model                August 2026
...
2.2.  Definitions
   ...
   *Background Scanning*:  method(s) of Unwanted Tracking detection that
      are running in the background on all Devices and may trigger
      Unwanted Tracking Alerts.  Contrast with Manual Scanning.
...
Delano, et al.           Expires 7 February 2027                [Page 6]

Internet-Draft              DULT Threat Model                August 2026
   ...
   *Manual Scanning*:  method(s) of detection that involve(s) a user
      initiated scan for nearby Accessories.  Contrast with Background
      Scanning.




Delano, et al.           Expires 7 February 2027                [Page 7]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027                [Page 8]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027                [Page 9]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 10]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 11]

Internet-Draft              DULT Threat Model                August 2026
   ...
   *  Access to technological safeguards
      ...
      -  High: The Target is able to safely use, and has access to,
         technological safeguards such as manual scanning apps.

      -  Limited: The Target is able to safely use, and has access to,
         technological safeguards such as manual scanning apps, but is
         unable to use their full capacity.



Delano, et al.           Expires 7 February 2027               [Page 12]

Internet-Draft              DULT Threat Model                August 2026


      -  Low: The Target is not able to use technological safeguards
         such as manual scanning apps, due to reasons of safety or
         access.
...
Delano, et al.           Expires 7 February 2027               [Page 13]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 14]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 15]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 16]

Internet-Draft              DULT Threat Model                August 2026
...
3.3.1.3.1.  Narrative
   ...
   having access to Lime’s computer and phone so that they can “make
   sure they are working well and that there are no dangerous apps.”
   Lemon hits Lime when angry and has threatened to out Lime as gay to
   their conservative parents and report them to Immigration & Customs
   Enforcement if Lime “talks back.” Lime met with an advocate at a
   local domestic violence program to talk about going to their shelter
   once a bed was available.  The advocate did some safety planning with
   Lime, and mentioned that there is an app that can scan for location
   Tags, but Lime did not feel safe installing this app because Lemon
   would see it.  The next time Lime went to see the advocate, they
   chose a time when they knew Lemon had to be at work until late to
   make sure that Lemon did not follow them, but when Lemon got home
   from work they knew where Lime had been.
...
Delano, et al.           Expires 7 February 2027               [Page 17]

Internet-Draft              DULT Threat Model                August 2026
...
3.3.1.3.2.  Analysis
   ...
   for the Target to engage in manual scanning, or to receive alerts on
   ...
   alerts collected through background scanning.
...
Delano, et al.           Expires 7 February 2027               [Page 18]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 19]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 20]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 21]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 22]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 23]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 24]

Internet-Draft              DULT Threat Model                August 2026
...
3.4.3.  Threat: Deploying Multiple Tags (Finding)
   ...
   whether background or manual, need to be able to return more than one
...
Delano, et al.           Expires 7 February 2027               [Page 25]

Internet-Draft              DULT Threat Model                August 2026
...
3.4.4.  Threat: Remote Advertisement Monitoring (Accessory, Network)
...
Delano, et al.           Expires 7 February 2027               [Page 26]

Internet-Draft              DULT Threat Model                August 2026
...
3.4.5.  Threat: Physically Modifying Tags (Accessory)
...
3.4.6.  Threat: Accessory Firmware Modifications (Accessory)
...
Delano, et al.           Expires 7 February 2027               [Page 27]

Internet-Draft              DULT Threat Model                August 2026
...
3.4.7.  Threat: Attacker Accessory Disablement (Accessory, Finding)
...
3.4.8.  Threat: Tracking Using Target's Own Tag (Network)
...
Delano, et al.           Expires 7 February 2027               [Page 28]

Internet-Draft              DULT Threat Model                August 2026


3.4.9.  Threat: Disabling Target Tag Detection (Network)

   An Attacker might intentionally disable background Unwanted Tracking
...
3.4.10.  Threat: Disabling Target Tag (Accessory, Network)
...
3.4.11.  Threat: Impersonation Attack (Tag; Accessory, Finding, Network)
...
Delano, et al.           Expires 7 February 2027               [Page 29]

Internet-Draft              DULT Threat Model                August 2026
...
3.4.12.  Threat: Impersonation Attack (Device)
...
3.4.12.1.  Threat: Attacks on Accessories (Accessory, Network)
...
Delano, et al.           Expires 7 February 2027               [Page 30]

Internet-Draft              DULT Threat Model                August 2026
...
3.4.12.2.  Threat: Attacks on Crowdsourced Network (Network)
...
3.4.13.  Threat: Replay Attack (Accessory, Network)
...
Delano, et al.           Expires 7 February 2027               [Page 31]

Internet-Draft              DULT Threat Model                August 2026
...
3.4.15.  Threat: Deploying GPS Tracker (Accessory)
...
Delano, et al.           Expires 7 February 2027               [Page 32]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 33]

Internet-Draft              DULT Threat Model                August 2026
...
4.  Design Considerations
   ...
   *  Include a variety of approaches to address different scenarios,
      including manual and background scanning and notifications or
      sounds
...
Delano, et al.           Expires 7 February 2027               [Page 34]

Internet-Draft              DULT Threat Model                August 2026
...
4.1.1.  Limitation: Spotty Implementation

   Current implementations of safeguards against Unwanted Tracking are
   inconsistent across Platforms and Devices.  For example, the types
   and methods of obtaining Unwanted Tracking Alerts vary.  Current
   Accessory types also vary widely in the amount and type of
   information they provide to a Target who has detected a possible
   unwanted tracker.  Platforms also differ in which brands of
   Accessories they can scan for and when Manual scanning can be
   performed.  This creates a situation where a Target’s ability to
   mitigate threats to their safety depends on consumer choices and
   access, placing a higher burden on Targets to find information
   specific to products, and creating challenges in creating easily
   understandable public safety information.  These differences can also
   be exploited by an Attacker familiar with target Platforms.  A
   successful protocol would support both Manual and Background Scanning
   as this increases options for Targets who may be dealing with highly
   individualized situations.  The information provided in Unwanted
   Tracking Alerts, and the options for a Target, would also benefit
   from standardization across Platforms and Devices.

4.1.2.  Limitation: Lack of customizability
...
Delano, et al.           Expires 7 February 2027               [Page 35]

Internet-Draft              DULT Threat Model                August 2026


4.1.3.  Limitation: Difficulty finding and disabling tags
...
4.1.4.  Limitation: Nonconformant Tags
...
Delano, et al.           Expires 7 February 2027               [Page 36]

Internet-Draft              DULT Threat Model                August 2026


4.1.5.  Limitation: Activities Logs
...
4.1.6.  Limitation: Anti-theft mode
   ...
   mitigation against Unwanted Tracking because it is only useful if the
   physical item is found by the person being tracked, a circumstance
   that this “Anti-theft” mode is designed to prevent.  Any mode that
   makes it possible to turn off Unwanted Tracking Alerts is
   antithetical to DULT’s recommendations.
...
Delano, et al.           Expires 7 February 2027               [Page 37]

Internet-Draft              DULT Threat Model                August 2026
...
4.2.1.  Detecting Unwanted Location Tracking
   ...
   detecting potentially Unwanted Tracking: 1) manual scanning, 2)
   background scanning, 3) tracking Tag alerts, and 4) Crowdsourced
   Network activities logs.

4.2.1.1.  Design Requirement: Manual Scanning

   There may be scenarios where a Target suspects that they are being
   tracked without their consent.  Manual scanning should allow a user
   ...
   near their Owners should not be shared to avoid abuse of the manual
   scanning feature.

4.2.1.2.  Design Requirement: Background Scanning

   Platforms should scan in the background for Tags suspected of
   Unwanted Tracking and notify the user.  This will involve
   implementing one or more algorithms to use to flag Tags and determine
   when to notify the user.  (A dedicated DULT WG document will address
   tracking algorithms, and will be linked when it is available.)  The
   user could be notified through a push notification or through Sounds
   and Haptics (see Section 4.2.1.3).  When a Tag has been identified as
   potentially being used for Unwanted Tracking, the user should be able
   to view the serial number of the Tag along with Obfuscated Owner
   Information for all accounts linked to the Tag and instructions on
   how to find and/or disable the Tag (see Section 4.2.2 and
   Section 4.2.3).  There will be tradeoffs between detecting potential
   Unwanted Tracking promptly and alerting the potential Target
   prematurely.  One way to handle these tradeoffs is to allow users to
   set the sensitivity of these alerts.  For example, the AirGuard
   (https://github.com/seemoo-lab/AirGuard) app includes three different
   "Security Level" settings that users can customize.
...
Delano, et al.           Expires 7 February 2027               [Page 38]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 39]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 40]

Internet-Draft              DULT Threat Model                August 2026
...
4.2.1.3.  Design Requirement: Location-tracking Tag Alerts

   Location-tracking Tags may be difficult to locate, and users may not
   have a Device that can scan manually or in the background for
   Location-tracking Tags.  The DULT Protocol should be built with
   accessibility in mind (https://cdt.org/insights/centering-disability-
   in-mitigating-harms-of-bluetooth-tracking-technology/) so that the
   most people can be protected by the protocol.  In addition to push
   notifications on nearby Devices, Location-tracking Tags themselves
   should be able to notify end users.  This should include periodic
   sounds when away from all Tag Owners, along with lights and haptics
   so that people who are Deaf or hard of hearing can still locate them.
   Tracking Tag Alerts should also educate the user on methods to
   successfully find and disable Tags (see Section 4.2.2 and
   Section 4.2.3).

4.2.1.4.  Design Requirement: Crowdsourced Network Activities Logs
...
Delano, et al.           Expires 7 February 2027               [Page 41]

Internet-Draft              DULT Threat Model                August 2026
...
4.2.2.  Finding Tracking Tags
   ...
   Even after a Tag is detected through background or manual scanning, a
   ...
   have discovered a Tag through background or manual scanning to
   request that the Tag signal its presence.  This assistance should be
   done in a way that is accessible to users with sensory or other
   impairments by using multimodal signals as described in
   Section 4.2.1.3.  Manufacturers/Platforms may also implement other
   methods to assist in locating Tags, such as precision finding using
   Ultra-wideband.
...
Delano, et al.           Expires 7 February 2027               [Page 42]

Internet-Draft              DULT Threat Model                August 2026
...
4.2.4.  Notification Management for Trusted Accessories
   ...
   should allow users to snooze background notifications from Location-
   ...
   during manual scans, helping users focus on unfamiliar or potentially
   ...
   triggering background notifications), and therefore should be
   approached with caution and abuse mitigation in mind.  These features
   are optional and may vary by Platform.  Whenever shared Ownership is
...
Delano, et al.           Expires 7 February 2027               [Page 43]

Internet-Draft              DULT Threat Model                August 2026
...
4.3.1.  Bluetooth constraints
   ...
   allowing background scanning by any nearby receiver.  While this
   enables open detection of unknown Tags, it also raises privacy
...
Delano, et al.           Expires 7 February 2027               [Page 44]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 45]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 46]

Internet-Draft              DULT Threat Model                August 2026
...
4.4.  Priorities for the DULT WG
   ...
   *  Priority 1: Manual Scanning
      ...
      -  The documents should ensure platforms implement manual scanning
...
Delano, et al.           Expires 7 February 2027               [Page 47]

Internet-Draft              DULT Threat Model                August 2026
...
6.  Normative References
   ...
   [I-D.draft-ledvina-apple-google-unwanted-trackers]
              ...
              unwanted-trackers-03, 24 June 2026,
              <https://datatracker.ietf.org/doc/html/draft-ledvina-
              apple-google-unwanted-trackers-03>.
...
Delano, et al.           Expires 7 February 2027               [Page 48]

Internet-Draft              DULT Threat Model                August 2026
...
Delano, et al.           Expires 7 February 2027               [Page 49]
```
