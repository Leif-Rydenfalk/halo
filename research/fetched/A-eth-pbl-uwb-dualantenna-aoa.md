# FETCHED: ETH-PBL/UWB_DualAntenna_AoA — open dual-antenna UWB angle-of-arrival

- **Source URL:** https://github.com/ETH-PBL/UWB_DualAntenna_AoA
- **Raw:** https://raw.githubusercontent.com/ETH-PBL/UWB_DualAntenna_AoA/main/README.md
- **Date fetched:** 2026-09-03
- **Licence:** GPL-3.0 (confirmed via GitHub API). Hardware files are **Altium** (.PcbDoc/.PrjPcb), not KiCad. 67 stars, last updated 2026-09-03.
- **Why it matters:** the strongest evidence that open-source UWB direction-finding is SOLVED for peer-to-peer — peer-reviewed, with hardware, firmware and a dataset.
