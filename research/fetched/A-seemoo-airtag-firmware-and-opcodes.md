# FETCHED: AirTag Scripts & Resources (firmware downgrade, L2CAP opcodes) — seemoo-lab/airtag

- **Source URL:** https://github.com/seemoo-lab/airtag  (raw: https://raw.githubusercontent.com/seemoo-lab/airtag/main/README.md)
- **Author:** Secure Mobile Networking Lab (SEEMOO), TU Darmstadt
- **Date fetched:** 2026-09-03
- **Why it matters:** documents the AirTag firmware update/downgrade mechanism (UARP over L2CAP "Durian" service), the U1 ("Rose") super-binary layout, and the full L2CAP command opcode list used to talk to the tag.
